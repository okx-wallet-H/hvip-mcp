...
```
hvip-mcp-server v0.2.54 · 365 MCP 工具 · 97.7% OKX REST 覆盖 · 仓库: https://github.com/okx-wallet-H/hvip-mcp
...
📖 对接标准 → docs/OKX-MCP-API对接标准-v0.2.49.md
...
v0.2.54 · 365 MCP 工具 · 覆盖 97.7% OKX REST API · P0 P1 全部清零 · 自检全绿
