...
export function classifyRisk(toolNameOrDesc: string): RiskLevel {
  ...
  const writePrefixes = [
    ...
    "strategy_signal_bot_create", "strategy_signal_bot_stop",
    "strategy_copy_start", "strategy_copy_stop", "strategy_copy_settings_set",
    "strategy_algo_place", "strategy_algo_cancel", "strategy_algo_amend",
    "fund_transfer", "fund_withdraw",
    "account_borrow_repay", "account_convert_trade",
    "account_leverage_set", "account_position_mode_set", "account_mode_set",
    "account_auto_earn_set", "account_auto_loan_set",
    "predict_event_place", "predict_event_cancel", "predict_event_amend",
    "predict_place", "predict_cancel",
    "predict_split", "predict_merge",
    "fund_eth_stake", "fund_eth_unstake", "fund_sol_staking_purchase", "fund_sol_staking_redeem",
    "trade_rfq_create", "trade_rfq_cancel", "trade_rfq_execute",
    "trade_spread_place", "trade_spread_cancel",
  ]
  ...
  const readSpecials = [
    ...
    "predict_ws_subscribe", "predict_ws_unsubscribe",
    "predict_ws_events", "predict_ws_status",
    "ws_xlayer_subscribe", "ws_xlayer_events", "ws_xlayer_unsubscribe",
    "code_status", "code_query",
    "sys_preference",
    // (deprecated: agent_simulate_transfer, agent_read_only_trade removed in v0.7)
