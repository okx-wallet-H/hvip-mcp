module.exports = {
  apps: [
    ...
    },
    {
      ...
      max_memory_restart: "300M",
      log_date_format: "HH:mm:ss",
      error_file: ".hub/logs/reviewer-error.log",
      out_file: ".hub/logs/reviewer-out.log",
      merge_logs: true,
      env: {
        NODE_ENV: "production",
        AUTO_MERGE: "false",
    ...
    },
    {
      ...
      log_date_format: "HH:mm:ss",
      error_file: ".hub/logs/scaler-error.log",
      out_file: ".hub/logs/scaler-out.log",
      merge_logs: true,
      env: {
        NODE_ENV: "production",
        MAX_WORKERS: "5",
